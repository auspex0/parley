...
lib/                  budget policy/prompts, causal coordinator, frozen client assets
ui/index.html         page markup, no frameworks
ui/styles.css         styles
ui/app.js             browser behavior; versioned with the HTML and styles
```
